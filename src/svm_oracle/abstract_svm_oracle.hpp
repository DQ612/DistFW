...
public:
  ...
  static SpFeature GenerateFeatureMap(const Feature& x, const Feature& y) = 0;

  // Compute structural loss between the true and predicted labels.
  static double Loss(const Feature& y_truth, const Feature& y_predict) = 0;
  ...
  static Feature MaxOracle(const Feature& w, const Feature& x_i,
